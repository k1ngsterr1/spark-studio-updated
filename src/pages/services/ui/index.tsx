...
export const ServicesPage = () => {
  ...
  return (
    <div>
      {" "}
      <Meta
        title="Услуги | Spark Studio - Ваш Партнер по Веб-Дизайну и Разработке в Казахстане"
        ogTitle="Услуги | Spark Studio - Ваш Партнер по Веб-Дизайну и Разработке в Казахстане"
